...
- Vídeo da Automação: `automacao-loop.mp4` (loop de 20,9 s em três atos: validar, gerar e conferir unifilar, blocos e planta; uma legenda por ato) com pôster `automacao-loop-poster.jpg` (o unifilar pronto)
