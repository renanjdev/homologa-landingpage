...
export default function App() {
  return (
    <BrowserRouter>
      <ScrollToTop />
      <CookieConsent />
      <Suspense fallback={<div data-preloader className="min-h-screen bg-void flex items-center justify-center"><img src="/logo-h-white.png" alt="Homologa Plus" width={48} height={48} className="w-12 h-12 animate-pulse" /></div>}>
        <Routes>
